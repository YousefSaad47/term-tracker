export const EditSubjectFormSkeleton = () => {
  return (
    <div className="container space-y-4 max-w-md animate-shimmer">
      <div className="flex flex-col space-y-2">
        ...
        <div className="h-10 w-full bg-neutral-300 dark:bg-neutral-700 rounded-lg" />
      </div>
      ...
      <div className="flex flex-col space-y-2 mt-8">
        <div className="h-6 w-32 bg-neutral-300 dark:bg-neutral-700 rounded-lg mx-auto" />
